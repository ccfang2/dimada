...
#' @export
#'
#' @note The function \code{create_index_matrix} in package \pkg{Sieve} is applied to help with the generation of multivariate sieves in function \code{cosine.gen}.
#'
